...
public class Employee_bee extends Bees {
    ...
    {
        if(this.ventre >=  (double) (GamePanel.SOURCES_MAXIMUM_QUANTITY * 5) / 100)
        {
            GamePanel.les_bananes.add(new Banana(this.bee_id,this.bee_xpos + GamePanel.UNIT_SIZE*3,
                    GamePanel.UNIT_SIZE* 3 + this.bee_ypos));

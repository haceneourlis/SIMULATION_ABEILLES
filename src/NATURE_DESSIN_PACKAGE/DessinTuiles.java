...
public class DessinTuiles{
    ...
    public void getTileImage() {
        try {
            tuile[0] = new Tuile();
            tuile[0].image = ImageIO.read(getClass().getResourceAsStream("/TALES/grass01.png"));


            tuile[1] = new Tuile();
            tuile[1].image = ImageIO.read(getClass().getResourceAsStream("/TALES/water00.png"));

            tuile[2] = new Tuile();
            tuile[2].image = ImageIO.read(getClass().getResourceAsStream("/TALES/floor01.png"));

            tuile[3] = new Tuile();
            tuile[3].image = ImageIO.read(getClass().getResourceAsStream("/TALES/earth.png"));

            tuile[4] = new Tuile();
            tuile[4].image = ImageIO.read(getClass().getResourceAsStream("/TALES/tree.png"));

            tuile[5] = new Tuile();
            tuile[5].image = ImageIO.read(getClass().getResourceAsStream("/TALES/wall.png"));
        }catch (IOException e)
        {
            e.printStackTrace();
        }
